...
STAR --genomeDir $INDEX \
    --readFilesIn $READS/SRX3461268_T1_2.fastq.gz $READS/SRX3461268_T1_1.fastq.gz \
    ...
    --outFileNamePrefix Kernfeld_e18/e18_rep2

cd Kernfeld_e18/
scTE -i e18_rep2Aligned.sortedByCoord.out.bam -o Kernfeld_e18_rep2 -x ../mm10.exclusive.idx --hdf5 True -CB CR -UMI UR
scTE -i e18_rep2Aligned.sortedByCoord.out.bam -o Kernfeld_e18_rep2 -x ../mm10.exclusive.idx -CB CR -UMI UR    