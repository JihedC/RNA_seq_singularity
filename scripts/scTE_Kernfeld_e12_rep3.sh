...
STAR --genomeDir $INDEX \
    --readFilesIn $READS/SRX3461254_T1_2.fastq.gz $READS/SRX3461254_T1_1.fastq.gz \
    ...
    --outFileNamePrefix Kernfeld_e12/e12_rep3

cd Kernfeld_e12/
scTE -i e12_rep3Aligned.sortedByCoord.out.bam -o Kernfeld_e12_rep3 -x ../mm10.exclusive.idx --hdf5 True -CB CR -UMI UR
scTE -i e12_rep3Aligned.sortedByCoord.out.bam -o Kernfeld_e12_rep3 -x ../mm10.exclusive.idx -CB CR -UMI UR    